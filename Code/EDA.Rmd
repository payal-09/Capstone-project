...
Assault has higer chance to occur in summer time whereas Break and Enter , Auto theft have higer chance to happen in between september and november month.However occurrences of Theft over reamin same throughout the year.
```{r }
df <- crime_data %>%
...
Assualt has higher chance to happen in weekends. Break and Enter has higher chance to happen on friday. 
```{r }
df <- crime_data %>%
...
```
##Observations
While "Assaults"" are the most common crimes throughout the day.It is more likely to happen from the afternoon till nights and in the early mornings."Break and Enter" most likely to occur during early morning time and afternoon time. Whereas "Robbery" and "Auto Theft" happened more offen from the late eveing till the nights.
